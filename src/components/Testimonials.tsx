        ...
        <motion.div
            ...
            <div className="flex flex-col sm:flex-row sm:flex-wrap gap-6">
                {testimonialsData.map((testimonial, index) => (
                    <div className='bg-white/20 p-12 rounded-lg shadow-md border w-80 m-auto cursor-pointer hover:scale-[1.04] transition-all duration-300'
                        key={index}>
                        <div className='flex flex-col items-center'>
                            <img className='w-14' src={testimonial.image} alt="" />
